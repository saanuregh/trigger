...
import type { RunStatus, StepStatus } from "../../types.ts";
...
const statusConfig: Record<RunStatus | StepStatus, IconConfig & { bg: string }> = {
...
const stepIconConfig: Record<StepStatus, IconConfig & { color: string }> = {
...
export function StatusDot({ status }: { status: RunStatus | StepStatus }) {
  return (
