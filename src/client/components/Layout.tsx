    ...
    <div className="flex flex-col h-screen">
      <header className="bg-gray-900 border-b border-gray-800 px-4 h-11 flex items-center justify-between shrink-0 shadow-md shadow-black/10">
        <nav className="flex items-center gap-1.5 text-sm">
          <a href="/" className="inline-flex items-center gap-1.5 font-bold tracking-wide text-white no-underline hover:text-blue-400 transition-colors">
      ...
      <div className="flex flex-1 overflow-hidden">
        {sidebar && (
          <aside className="w-56 bg-gray-900/50 border-r border-gray-800 overflow-y-auto shrink-0 p-3">
            {sidebar}
          </aside>
        )}
