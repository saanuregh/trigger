...
await Bun.write(
  ...
  JSON.stringify({
    ...
    main: "index.js",
    type: "module",
    license: sdkPkg.license,
    author: sdkPkg.author,
    repository: sdkPkg.repository,
    keywords: sdkPkg.keywords,
    engines: sdkPkg.engines,
...
// Copy README for the SDK package
await Bun.write("dist/@saanuregh/trigger-sdk/README.md", Bun.file("packages/trigger-sdk/README.md"));
